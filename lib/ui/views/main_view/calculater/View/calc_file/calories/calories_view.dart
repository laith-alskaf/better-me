            ...
            children: [
              ...
              IconButton(onPressed: (){
                AwesomeDialog(
                    ...
                    title: 'يساعد حاسب السعرات على حساب معدل احتياجاتك من السعرات الحرارية',
                  titleTextStyle: TextStyle(color: AppColors.lighred),
                )..show();
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              cursorColor: AppColors.caloriesview,
                              decoration: InputDecoration(
                                  focusedBorder:UnderlineInputBorder(
                                    borderSide:  BorderSide(color: AppColors.caloriesview, width: 1.5),
                                  ),
                        ...
                        children: [
                          Padding(
                            ...
                            child: ElevatedButton(onPressed: (){
                              ...
                              calories=calloresneed(bmr,traningtxt);

                              AwesomeDialog(
                                dialogType: DialogType.noHeader,
                                  context: context,
                                  animType: AnimType.rightSlide,
                                  title: 'كمية السعرات المحتاجة يوميا',titleTextStyle: TextStyle(color: AppColors.lighred),
