import 'dart:math';
import 'package:BetterMe/ui/views/main_view/medicine_reminder/constants.dart';
import 'package:BetterMe/ui/views/main_view/medicine_reminder/global_bloc.dart';
import 'package:BetterMe/ui/views/main_view/medicine_reminder/models/errors.dart';
import 'package:BetterMe/ui/views/main_view/medicine_reminder/models/medicine_type.dart';
import 'package:BetterMe/ui/views/main_view/medicine_reminder/pages/home_page.dart';
import 'package:BetterMe/ui/views/main_view/medicine_reminder/pages/new_entry/new_entry_bloc.dart';
import 'package:BetterMe/ui/views/main_view/medicine_reminder/pages/success_screen/success_screen.dart';
...
import 'package:BetterMe/ui/views/main_view/medicine_reminder/models/medicine.dart';
...
class _NewEntryPageState extends State<NewEntryPage> {
  ...
  Future<void> scheduleNotification(Medicine medicine,DateTime date) async {
    ...
    // const RawResourceAndroidNotificationSound sound =  RawResourceAndroidNotificationSound("sound.mp3");
    // const AndroidNotificationSound sound1= RawResourceAndroidNotificationSound("sound.mp3");
    ...
    for (int i = 0; i < (24 / medicine.interval!).floor(); i++) {
      ...
      await flutterLocalNotificationsPlugin.zonedSchedule(
          ...
          medicine.medicineType.toString() != MedicineType.None.toString()
              ? 'It is time to take your ${medicine.medicineType!.toLowerCase()}, according to schedule'
              : 'It is time to take your medicine, according to schedule',
          tz.TZDateTime.now(tz.local).add( Duration(hours:hour-date.hour,minutes:minute-date.minute)),
          platformChannelSpecifics,
